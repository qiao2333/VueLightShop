<template>
	<div>
		...
		<div style="height: auto;width: auto;padding-top: 50px;">
			<div>
				<div style="text-align: center;font-size: large;">
					<h1><Icon type="ios-cafe-outline" />&nbsp;&nbsp;今日推荐</h1>
				</div>
				<Divider />
			</div>
		</div>
		<div>
			...
			<div v-else>
				<div style="text-align: center;padding-top: 40px;">
					<Row>
						...
						<div style="float: left;padding-left: 80px;">
							<img style="height: 80px;width: 270px;" src="../../assets/lightlogo.png" />
						</div>
						<div style=" width: 800px; text-align: center;padding-left: 360px;padding-top: 40px;">
				...
				<div style="padding-top: 30px;">
					<Drawer title="高级筛选" v-model="drawerOpen" width="360" :mask-closable="false">
						<Form :model="formItem">
							<Row>
								<Col>
								<FormItem label="灯饰名称">
							...
							<ButtonGroup>
								<Button type="primary" @click="heightSearch">提交</Button>
							</ButtonGroup>
						</Form>
					</Drawer>
				</div>
				<div>
					...
					<Row>
						<template>
							<div style="height: 60px;width: auto;text-align: center;padding-top: 20px;">
